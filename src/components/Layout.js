...
function Logo() {
  return (
    <Link to="/" className="logo">
      ...
      <span className="logo-text">Pixl<span>Tools</span></span>
    </Link>
  );
}
        ...
        <footer className="global-footer">
          <div className="footer-content">
            <div className="footer-left">
              <span className="footer-copy">© 2026 PixlTools</span>
              <span className="footer-divider" />

              {/* Conditional AGPL Link - only on tools using @imgly */}
              {(pathname === '/background-remover' || pathname === '/passport-photo') ? (
                <a href="https://github.com/BALURAM1226/PixlTools" target="_blank" rel="noopener noreferrer" className="footer-link-git" title="View Source Code">
